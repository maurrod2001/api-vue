<template>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3>Consultar por nombre

                </h3>
                <!--Consultar por Id. llama el metodo getallbyid()-->
                <input type="text" id="txtid" class="form-control" placeholder="Nombre"> <br>
                <button class="btn btn-primary" @click="getAllById()">Buscar por Nombre</button>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <button class="btn btn-info me-5" @click="add_contact()">Insertar un medico</button>
                <button class="btn btn-warning" @click="update()">Actualizar un medico</button>
...
export default {
    ...
    methods: {
        getAll() {
            axios.get('http://localhost:3000/medic')
                .then((response) => {
        ...
        getAllById() {
            ...
            axios.get('http://localhost:3000/medic/' + no)
                .then((response) => {
        ...
        , delete_contact() {
            ...
            axios.delete('http://localhost:3000/pacient/' + id)
                .then(res => {
